...
import static ru.meridor.stecker.dev.BuildToolClassLoaderFactory.getClassesPath;
import static ru.meridor.stecker.dev.BuildToolClassLoaderFactory.getDependenciesPath;
...
public class BuildToolClassLoaderFactoryTest {
    ...
    public void testGetClassesPath() throws Exception {
        assertThat(getClassesPath(BASE_DIRECTORY, buildToolType), equalTo(correctClassesPath));
    }

    @Test
    public void testGetDependenciesPath() throws Exception {
        assertThat(getDependenciesPath(BASE_DIRECTORY, buildToolType), equalTo(correctDependenciesPath));
    }
